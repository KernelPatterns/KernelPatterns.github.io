"""
SortinoHyperOptLossWithTradePenalty
...
class SortinoHyperOptLossWithTradePenalty(IHyperOptLoss):
    """
    Defines the loss function for hyperopt.

    This implementation uses the Sortino Ratio calculation with a trade distribution penalty.
    """
    ...
    def hyperopt_loss_function(
        ...
        **kwargs,
        ...
        Uses Sortino Ratio calculation with a penalty for unbalanced trade distribution.
        """
        ...
        # Combine Sortino ratio and trade distribution penalty
        combined_loss = -sortino_ratio + duration_penalty + trade_loss + profit_loss #+ trade_distribution_penalty
